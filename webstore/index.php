...
<div class="container py-4">
    <div class="p-5 mb-4 bg-light rounded-3">
        <div class="container-fluid py-5">
            <h1 class="display-5 fw-bold pageTitle">Online Store</h1>
            <p class="col-md-9 fs-4 pageDescription">Expand your reach and start generating sales online 365 days a year.</p>
        </div>
    </div>
</div>
